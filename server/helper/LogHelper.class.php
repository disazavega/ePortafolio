 ...
 *
 * Usage:
 * $log = new LogHelper('/var/log/', LogHelper::INFO);
...
class LogHelper
{
     ...
     */
    const NO_ARGUMENTS = 'LogHelper::NO_ARGUMENTS';
    ...
    /**
     * Array of LogHelper instances, part of Singleton pattern
     * @var array
     */
    ...
    /**
     * Sets the date format used by all instances of ,
